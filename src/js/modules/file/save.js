...
class File_save_class {
  ...
  save_action(user_response, autoname) {
    ...
    if (this.Helper.strpos(fname, ".png") !== false) type = "PNG"
    else if (this.Helper.strpos(fname, ".jpg") !== false) type = "JPG"
    else if (this.Helper.strpos(fname, ".json") !== false) type = "JSON"
    else if (this.Helper.strpos(fname, ".bmp") !== false) type = "BMP"
    else if (this.Helper.strpos(fname, ".webp") !== false) type = "WEBP"
