...
class Text_class extends Base_tools_class {
  ...
  render(ctx, layer) {
    ...
    //set styles
    if (params.bold && params.italic) ctx.font = "Bold Italic " + size + "px " + font
    else if (params.bold) ctx.font = "Bold " + size + "px " + font
    else if (params.italic) ctx.font = "Italic " + size + "px " + font
  ...
  render_text_line(ctx, layer, text, offset_y) {
    ...
    if (stroke == false) ctx.fillText(text, start_x, layer.y + offset_y)
    else ctx.strokeText(text, start_x, layer.y + offset_y)
  }
