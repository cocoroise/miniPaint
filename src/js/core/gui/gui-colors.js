...
class GUI_colors_class {
  ...
  set_events() {
    ...
    //colors
    document.getElementById("color_hex").addEventListener(
      "keyup",
      function(e) {
    ...
    document.getElementById("main_color").addEventListener(
      "change",
      function(e) {
  ...
  render_colors(ignore_id) {
    ...
    if (ignore_id !== "hsl_h") document.getElementById("hsl_h").value = Math.round(hsl.h * 360)
    if (ignore_id !== "hsl_s") document.getElementById("hsl_s").value = Math.round(hsl.s * 100)
    if (ignore_id !== "hsl_l") document.getElementById("hsl_l").value = Math.round(hsl.l * 100)
  }
