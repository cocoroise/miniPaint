...
class GUI_layers_class {
  ...
  render_layers() {
    ...
    for (var i in layers) {
      ...
      if (value.id == config.layer.id) html += '<div class="item active">'
      else html += '<div class="item">'
      if (value.visible == true)
        html +=
          '	<span class="visibility visible" id="visibility" data-id="' +
          value.id +
          '" title="hide"></span>'
      else
        html +=
          '	<span class="visibility" id="visibility" data-id="' + value.id + '" title="show"></span>'
      html += '	<span class="delete" id="delete" data-id="' + value.id + '" title="delete"></span>'
      html +=
        '	<span class="layer_name" id="layer_name" data-id="' +
        value.id +
        '">' +
        value.name +
        "</span>"
